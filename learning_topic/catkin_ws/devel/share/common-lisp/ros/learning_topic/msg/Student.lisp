...
(cl:defmethod msg-val ((m <Student>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader learning_topic-msg:msg-val is deprecated.  Use learning_topic-msg:msg instead.")
  (msg m))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Student>)))
  ...
  "b76ec3a538902e4d1c321cf33dc84b32")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Student)))
  "Returns md5sum for a message object of type 'Student"
  "b76ec3a538902e4d1c321cf33dc84b32")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Student>)))
  ...
  (cl:format cl:nil "string msg~%uint8 sex~%uint8 age~%uint8 height~%uint8 weight~%uint8 female = 0~%uint8 male = 1~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Student)))
  "Returns full string definition for message of type 'Student"
  (cl:format cl:nil "string msg~%uint8 sex~%uint8 age~%uint8 height~%uint8 weight~%uint8 female = 0~%uint8 male = 1~%~%"))
